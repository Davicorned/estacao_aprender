...
const items = [
  ...
  },
  {
    ...
    text: "O Espaço IDE é um ambiente acolhedor e bem organizado, com oficinas criativas e envolventes. Meu filho participa das oficinas e a última foi a de Páscoa e ele adorou! Atividades bem planejadas, com cuidado e estímulo à criatividade. Recomendo bastante!",
  },
  {
    name: "Isah Adriano",
    text: "Tive uma experiência muito boa no Espaço IDE. A equipe é super atenciosa, acolhedora e dá pra ver que realmente se importam com as crianças. Além do espaço belíssimo e acolhedor, os profissionais passam bastante segurança, explicam tudo direitinho e mantêm a gente sempre informado. Dá pra perceber o cuidado e a dedicação no trabalho. Recomendo pra quem procura um atendimento mais humano e de confiança.",
  },
];
